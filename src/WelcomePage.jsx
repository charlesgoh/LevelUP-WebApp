  ...
  render() {
    return (
      <Slider>
        ...
        <Slide src="https://farm5.staticflickr.com/4370/36706542465_8aa13a24e6_b.jpg" title="Physical fitness is not only one of the most important keys to a healthy body, it is the basis of dynamic and creative intellectual activity" placement="right">
          John F. Kennedy
        </Slide>
